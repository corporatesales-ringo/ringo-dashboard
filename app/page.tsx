...
export default function RevenueDashboardReact() {
  ...
  const [compareMode, setCompareMode] = useState<string>("lastYear");
  ...
  const addManualRow = () => {
    if (!form.date || !form.account || !form.amount) return;
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <KpiCard
            ...
            subtext={`${currencyFmt.format(
              requiredDailyRunRate
            )}/day needed to hit month`}
            icon={Target}
          />
        </div>
              ...
              <CardContent className="space-y-4">
                <div className="rounded-2xl bg-slate-50 p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">
                      {currencyFmt.format(goals.monthTarget)}
                    </span>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="rounded-2xl bg-slate-50 p-4">
                    ...
                    <p className="mt-2 text-2xl font-semibold">
                      {currencyFmt.format(requiredDailyRunRate)}
                    </p>
                  </div>
                </div>
              ...
              <Dialog>
                ...
                <DialogContent className="rounded-3xl sm:max-w-lg">
                  ...
                  <div className="grid gap-4 pt-2">
                    ...
                    <Button onClick={addManualRow} className="rounded-2xl">
                      Save entry
                    </Button>
                  </div>
                </DialogContent>
